      ...
      <div className="section-container relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-20">
          <motion.a
            ...
            className="w-64 h-64 lg:w-80 lg:h-80 rounded-3xl bg-white/20 backdrop-blur-sm p-4 flex items-center justify-center shadow-2xl cursor-pointer hover:scale-105 transition-transform"
          >
            <img
          ...
          >
            <a href="https://discord.gg/CGmxFdwfCV" target="_blank" rel="noopener noreferrer">
              <h2 className="text-4xl lg:text-5xl font-bold text-white mb-4 drop-shadow-sm hover:opacity-80 transition-opacity">
                SkyBlue
              </h2>
            </a>
